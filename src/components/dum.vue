        ...
        <div class="col-md-12">
          ...
          >
            ...
            >
              ...
              <a
                class="btn btn-primary"
                href="#formChangePassword"
              >Password</a>
              <a
                class="btn btn-primary"
                href="#formResetPassword"
              >Reset</a>
              <a
                class="btn btn-primary"
                href="#formPayment"
                ...
                <div class="card-body">
                  ...
                  >
                    <div class="form-group">
                      ...
                      >Password reset instructions will be sent to this email address.</span>
                    </div>
                    <div class="form-group">
                      <button
                        class="btn btn-success btn-lg float-right"
              ...
              <div class="card card-outline-secondary">
                ...
                <div class="card-body">
                  <div class="row mt-4">
                    ...
                    <div class="col-sm-3 pb-3">
                      <label for="exampleSt">State</label> <select
